...
const Reports = () => {
  ...
  return (
    ...
    <div className='flex self-center min-h-[10vh] md:w-[50%] w-[100%] bg-[#e9eae7] rounded-lg'>
        <MdOutlineClose className='absolute md:right-[25%] right-0 text-2xl cursor-pointer' onClick={toggleCloseReport}/>
